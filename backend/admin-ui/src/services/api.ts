...
function friendlyApiError(code: string): string {
  const messages: Record<string, string> = {
    ...
    novel_review_not_pending: '该作品已不在待审核状态，请刷新后重试',
    chapter_requires_novel_review: '该章节属于整书投稿，请在整书审核队列中处理',
    chapter_review_not_pending: '该章节已不在待审核状态，请刷新后重试',
    ...
    batch_review_items_required: '请至少选择一项待审核内容',
    batch_review_limit_exceeded: '单次最多处理 100 项内容',
    batch_review_item_invalid: '所选审核项无效，请刷新后重新选择',
    batch_review_duplicate: '所选审核项存在重复，请刷新后重试',
    batch_review_nested_target_conflict: '整书审核已包含其章节，不能同时勾选该书内章节',
    ...
    chat_bot_avatar_file_required: '请选择机器人头像图片',
    chat_bot_avatar_file_too_large: '机器人头像不能超过 3MB',
    chat_bot_avatar_type_invalid: '机器人头像仅支持 JPG、PNG 或 WebP',
    chat_bot_avatar_content_invalid: '头像内容与文件类型不一致，请重新选择',
    chat_bot_avatar_upload_required: '请通过头像上传区域选择图片，不能填写外部地址',
    chat_bot_avatar_not_found: '机器人头像文件不存在，请重新上传',
    chat_bot_enable_requires_credentials: '启用机器人前请补齐 API Key、接口地址和模型',
    chat_bot_provider_invalid: '请选择有效的机器人服务商',
    chat_bot_base_url_invalid: '机器人接口地址必须是 HTTPS 地址',
    chat_bot_name_required: '请填写机器人名称',
    chat_bot_skin_invalid: '请选择有效的机器人皮肤',
    chat_bot_trigger_mode_invalid: '请选择有效的机器人触发方式',
    app_announcement_content_required: '启用公告前请填写公告内容',
    iflytek_asr_enable_requires_credentials: '启用语音识别前请补齐 App ID、API Key 和对应签名密钥',
    iflytek_asr_product_type_invalid: '请选择有效的讯飞识别产品类型',
    iflytek_asr_host_invalid: '讯飞识别地址必须是 WSS 地址',
    iflytek_tts_enable_requires_credentials: '启用语音合成前请补齐 App ID、API Key 和 API Secret',
    iflytek_tts_host_invalid: '讯飞合成地址必须是 WSS 地址',
    settings_secret_value_invalid: '密钥字段格式无效，请重新输入',
    settings_secret_not_clearable: '该配置项不支持清除',
    settings_payload_invalid: '配置内容格式无效',
    settings_enabled_invalid: '配置开关值无效',
    proxy_node_switch_failed: '节点切换未完成，原策略已尝试恢复',
    proxy_node_switch_rollback_failed: '节点切换和原策略恢复都失败，请立即检查代理服务',
    proxy_control_failed: '代理控制器暂时不可用，请检查服务器服务状态',
    proxy_control_unavailable: '代理控制器未安装或无权执行',
    proxy_control_timeout: '代理操作超时，请稍后查看服务状态',
    mihomo_service_inactive: 'Mihomo 服务未运行，无法执行该操作',
    mihomo_controller_unavailable: 'Mihomo 控制器暂时不可用',
    game_not_found: '游戏不存在或已无法管理',
    game_visibility_invalid: '请选择有效的游戏展示状态',
    game_not_controllable: '这款游戏没有可远程控制的独立服务',
    game_action_invalid: '请选择启动、停止或重启操作',
    game_control_unavailable: '游戏服务控制器暂时不可用，请检查服务器配置与权限',
    game_control_timeout: '游戏服务操作超时，请刷新后确认实时状态',
    game_control_action_failed: '游戏服务操作失败，请检查对应服务日志',
    game_control_state_mismatch: '操作已执行，但服务没有进入预期状态，请立即检查服务日志',
    game_service_not_running: '游戏服务尚未全部运行，确认状态正常后才能在 App 中显示',
    game_control_busy: '这款游戏已有启停操作正在进行，请稍后刷新状态',
    kdjx_player_not_found: '该用户尚未关联 KDJX 游戏账号',
    kdjx_player_identity_incomplete: '玩家尚未同步完整的游戏账号、角色和服务器信息',
    kdjx_player_link_changed: '玩家当前角色或服务器已经变化，请刷新后重新发放',
    kdjx_session_status_changed: '玩家的游戏会话状态已经变化，请刷新后重试',
    expected_active_sessions_invalid: '页面中的游戏会话数量无效，请刷新后重试',
    game_order_id_invalid: 'KDJX 游戏订单号格式无效',
    payment_not_found: 'KDJX 支付订单不存在或已被移除',
    kdjx_payment_not_retryable: '订单已在处理或已经到账，不能再次补发',
    kdjx_payment_status_changed: '订单状态已经变化，请刷新后重试',
    kdjx_payment_version_changed: '订单已被其他管理员处理，请刷新后确认最新投递次数',
    kdjx_payment_delivery_failed: '订单补发仍未到账，请检查游戏服务状态',
    expected_attempts_invalid: '页面中的订单投递次数无效，请刷新后重试',
    kdjx_gm_audit_unavailable: '操作审计暂不可用，本次操作未执行，请稍后重试',
    kdjx_gm_item_not_found: '所选物品已不在服务器发放目录中，请刷新后重新选择',
    kdjx_gm_delivery_type_not_allowed: '所选物品不支持当前发放方式，请重新选择',
    kdjx_gm_quantity_exceeds_limit: '发放数量超过该物品的单次上限',
    kdjx_gm_delivery_idempotency_conflict: '同一发放请求号的内容不一致，请关闭窗口后重新发起',
    kdjx_gm_delivery_not_found: '发放记录没有成功写入，请核对历史记录',
    request_id_invalid: '发放请求号无效，请关闭窗口后重新发起',
    delivery_type_invalid: '请选择有效的物品发放方式',
    item_id_invalid: '请选择物品目录中的有效物品',
    quantity_invalid: '请输入有效的正整数发放数量',
    expected_role_id_invalid: '页面中的角色信息无效，请刷新后重试',
    expected_server_key_invalid: '页面中的服务器信息无效，请刷新后重试',
    expected_link_updated_at_invalid: '页面中的角色关联版本无效，请刷新后重试',
    reason_invalid: '请填写 4 至 160 个字的具体操作原因',
    query_too_long: '搜索内容过长，请缩短后重试',
    page_invalid: '分页参数无效，请刷新后重试',
    page_size_invalid: '每页数量无效，请刷新后重试',
    status_invalid: '请选择有效的状态筛选项',
