...
import '../features/card_game/gacha_visual_demo_screen.dart';
...
class GameCenterScreen extends StatelessWidget {
  ...
  static const Key gachaEntryKey = ValueKey<String>('game-entry-gacha');
  ...
  final WidgetBuilder? gachaDestinationBuilder;
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildListDelegate.fixed([
                          _GameEntryCard(
                            ...
                            eyebrow: '视觉样片',
                            title: '樱愿召唤',
                            description: '见证 N、SR、SSR、UR 四档揭晓，体验单抽与十连演出。',
                            actionLabel: '进入召唤',
                            ...
                            accent: const Color(0xFFFFC7E6),
                            onTap: () => _open(
                              context,
                              gachaDestinationBuilder ??
                                  (_) => const GachaVisualDemoScreen(),
                            ),
                          ),
                          _GameEntryCard(
